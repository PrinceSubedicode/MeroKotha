...
export function MeroKothaIcon({ className = "h-10 w-10", size = 40 }) {
  return (
    ...
    >
      ...
      {/* Top-Left Quadrant */}
      <rect x="42.5" y="59" width="6.5" height="6.5" rx="1" fill="#009a96" />
      {/* Top-Right Quadrant */}
      <rect x="51" y="59" width="6.5" height="6.5" rx="1" fill="#009a96" />
      {/* Bottom-Left Quadrant */}
      <rect x="42.5" y="67.5" width="6.5" height="6.5" rx="1" fill="#009a96" />
      {/* Bottom-Right Quadrant */}
      <rect x="51" y="67.5" width="6.5" height="6.5" rx="1" fill="#009a96" />
    </svg>
  );
}
